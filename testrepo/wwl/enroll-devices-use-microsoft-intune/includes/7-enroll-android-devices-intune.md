...
1. Follow the instructions given in the Company Portal. The end-user experience can vary based on the policies assigned to the user and/or device.
...
For more information, see [Enroll Android devices](https://aka.ms/AA6du6k).
