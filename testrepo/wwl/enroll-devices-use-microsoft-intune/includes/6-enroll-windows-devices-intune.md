...
:::image type="content" source="../media/windows-add-work-school-account-40b25f77.png" alt-text="Screenshot of the Set up a work or school account window that appears after selecting Connect from the Access work or school page.":::
...
:::image type="content" source="../media/windows-enroll-sign-work-school-dda8cbb6.png" alt-text="Screenshot of the Set up a work or school account window that appears after selecting the Enroll only in device management option from the Access work or school page in Intune.":::
